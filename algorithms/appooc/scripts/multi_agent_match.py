...
RIVALS = [
    Rival(name='duel', args=['--env=doom_duel', '--algo=appooc', '--experiment=00_bots_ssl2_fs2_ppo_1', '--experiments_root=paper_doom_duel_v65_fs2/bots_ssl2_fs2']),
    Rival(name='duel_bots', args=['--env=doom_duel_bots', '--algo=appooc', '--experiment=00_bots_ssl2_fs2_ppo_1', '--experiments_root=paper_doom_duel_bots_v65_fs2/bots_ssl2_fs2']),
]
