...
from algorithms.appooc.appooc_utils import TaskType, make_env_func, set_gpus_for_process
from algorithms.appooc.policy_manager import PolicyManager
...
class VectorEnvRunner:
    ...
    def reset(self, report_queue):
        ...
        :param report_queue: we use report queue to monitor reset progress (see appooc.py). This can be a lengthy
        process.
