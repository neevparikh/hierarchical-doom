...
def main():
    ...
    attention_scores_no_vel = np.array([[0, 0.39367, 0.29643,
                                         0.30989], [0.36004, 0, 0.32138,
                                                    0.31858], [0.32372, 0.30816, 0, 0.36811],
    ...
    # plt.show()
    plt.savefig(os.path.join(os.getcwd(), f'attn_study.pdf'),
                format='pdf',
                bbox_inches='tight',
                pad_inches=0.02)
